...
/**
 * The smallest board the domain will hold: one square. Which boards are worth *playing* is the
 * puzzle's own answer and travels on `Puzzle.sizes` — a board of three has no eight-queens
 * solution and other puzzles do, and neither fact belongs to the family.
 */
public const val MIN_BOARD_SIZE: Int = 1
